...
class TaskResourceIT {
    ...
    private static final Long DEFAULT_IDENTITY = 1L;
    private static final Long UPDATED_IDENTITY = 2L;
    ...
    void getAllTasks() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].identity")
            .value(hasItem(DEFAULT_IDENTITY.intValue()))
            .jsonPath("$.[*].duedate")
            .value(hasItem(DEFAULT_DUEDATE.toString()))
            .jsonPath("$.[*].completed")
    ...
    void getAllTasksWithEagerRelationshipsIsEnabled() {
        when(taskRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(Flux.empty());
    ...
    void getTask() {
        ...
        webTestClient
            ...
            .jsonPath("$.identity")
            .value(is(DEFAULT_IDENTITY.intValue()))
            .jsonPath("$.duedate")
            .value(is(DEFAULT_DUEDATE.toString()))
            .jsonPath("$.completed")
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).identity(UPDATED_IDENTITY).duedate(UPDATED_DUEDATE);
