...
public class TaskResource {
                ...
                Mono<Task> result = taskRepository
                    ...
                    .map(existingTask -> {
                        ...
                        if (task.getIdentity() != null) {
                            existingTask.setIdentity(task.getIdentity());
                        }
    ...
    public Mono<ResponseEntity<List<Task>>> getAllTasks(
        ...
        return taskRepository
            .count()
            .zipWith(taskRepository.findAllBy(pageable).collectList())
            .map(
                countWithEntities ->
                    ResponseEntity.ok()
                        .headers(
    ...
    public Mono<ResponseEntity<Task>> getTask(@PathVariable("id") Long id) {
        ...
        Mono<Task> task = taskRepository.findOneWithEagerRelationships(id);
